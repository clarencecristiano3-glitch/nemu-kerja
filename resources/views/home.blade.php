...
<body class="bg-white text-[#151442]">
    ...
    <section class="overflow-hidden border-b border-gray-200">
        ...
        <div class="mx-auto grid max-w-[1500px] grid-cols-1 items-center gap-10 px-6 py-14 lg:grid-cols-2 lg:px-10">
            ...
            <div>
                ...
                ">
                    ...
                    ">
                        ...
                        <input id="keyword" type="text" placeholder="Kata Kunci Pekerjaan" class="
                            w-full
                            bg-transparent
                            text-sm
                            outline-none
                    ...
                    ">
                        ...
                        <input id="location" type="text" placeholder="Lokasi Pekerjaan" class="
                            w-full
                            bg-transparent
                            text-sm
                            outline-none
            ...
            <div class="relative hidden h-full w-full items-center justify-center lg:flex">
                <img src="{{ asset('images/orang.png') }}" alt="Hero Image"
                    class="h-auto max-h-[1000px] w-full max-w-[1000px] object-contain">
            </div>

    </section>

    <section id="lowongan" class="
        mx-auto
        max-w-[1500px]
        px-6
        py-14
        ...
        ">
            ...
            @foreach($jobs as $job)
                        ...
                        <article class="
                            ...
                            hover:-translate-y-1
                            hover:shadow-xl"
                            data-category="{{ $job['category'] }}" data-search="{{ strtolower(
                    $job['company'] . ' ' .
                    $job['position'] . ' ' .
                    $job['location'] . ' ' .
                    $job['education']
    ...
    <footer id="perusahaan" class="relative bg-[#151442] text-white">
        ...
        <div class="absolute -top-13 right-4 lg:right-8 z-10">
            <img src="{{ asset('images/Panda.png') }}" alt="Panda Mascot" class="h-14 w-auto object-contain lg:h-16">
        </div>
        ...
        <div class="mx-auto grid max-w-[1300px] grid-cols-1 gap-10 px-8 py-16 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
                <a href="{{ route('home') }}" class="inline-block mt-3 lg:mt-4">
                    <img src="{{ asset('/public/images/panda_blue_with_hand.png') }}" alt="Nemu Kerja!"
